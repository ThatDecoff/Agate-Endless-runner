...
public class TerrainGeneratorController : MonoBehaviour
{
    ...
    private void GenerateTerrain(float posX, TerrainTemplateController forceterrain = null)
    {
        ...
        newTerrain.transform.position = new Vector2(posX, terrainYpos);
    ...
    private void OnDrawGizmos()
    {
        ...
        Vector3 lastGeneratePos = transform.position;
        Vector3 lastRemovedPos = transform.position;

        lastGeneratePos.x = lastGeneratedPositionX;
        lastRemovedPos.x = lastRemovedPositionX;
        ...
        Debug.DrawLine(lastGeneratePos + Vector3.up * debugLineHeight / 2, lastGeneratePos + Vector3.down * debugLineHeight / 2, Color.blue);
        Debug.DrawLine(lastRemovedPos + Vector3.up * debugLineHeight / 2, lastRemovedPos + Vector3.down * debugLineHeight / 2, Color.blue);
    }
}
